        ...
        while (currentState != MenuState.EXIT) {
            ...
            switch (currentState) {
                ...
                case STUDENT_RETURN:
                    ...
                    break;
                case STUDENT_FIND_BOOK:
                    studentFindBook(console);
                    break;
                case LIBRARIAN_MAIN:
...
//SETTINGS//////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    protected void studentMenu (Student student, Console console) {
        ...
        switch (ans) {
            ...
            case "3" : //see borrowed books list
                ...
                break;
            case "4" : //search book
                currentState = MenuState.STUDENT_FIND_BOOK;
                break;
            case "S" : //settings
                currentState = MenuState.SETTINGS;
                break;
    ...
    private void studentFindBook (Console console) {
    ...
    protected void librarianMenu (Librarian librarian, Console console) {
        ...
        switch (ans) {
            ...
            case "9" : //find book
                ...
                model.findBook(inputIsbn, inputTitle, inputAuthor).toString(); //TODO doesnt print the books
                break;
            case "S" : //settings
                console.writer().print("\033[H\033[2J");
                currentState = MenuState.SETTINGS;
